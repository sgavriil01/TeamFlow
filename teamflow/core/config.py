...
class Settings(BaseSettings):
    ...
    jira_client_id: str | None = Field(None, description="Jira OAuth client ID")
    jira_client_secret: str | None = Field(None, description="Jira OAuth client secret")
    slack_bot_token: str | None = Field(None, description="Slack bot token")
    slack_signing_secret: str | None = Field(None, description="Slack signing secret")
